import { ForgotPasswordLink } from "@/authentication/forgot-password/components/ForgotPasswordLink";
...
export const LoginForm = ({ className, onClick }: Props): ReactElement => {
 ...
 return (
  <AuthenticationFormCard {...{ className, cardClassName: 'h-3/5' }}>
   <div className="text-6xl flex font-semibold">{t('authentication:connection')}</div>
